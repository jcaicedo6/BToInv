...
TH1D *hSD_q2 = new TH1D("hSD_q2 ","hSD_q2 ",nbins,q2_Low,q2_Up);
...
TH1D *hBkgD_q2pdf = new TH1D("hBkgD_q2pdf","hBkgD_q2pdf",nbins,q2_Low,q2_Up);
...
void FindLimitCls_BToInvCombinedHad()
{
  SetData();
  Double_t limit[3];
  //Double_t lum = 361.6; 
...
Double_t getLimit(Double_t lum, Int_t type)
{
  ...
  RooHistPdf *b_pdf;
    ...
    //******************* D_tag
    //
    //TFile *fSDXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m00_Xps_pdf.root");
    //TFile *fSDXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m10_Xps_pdf.root");
    //TFile *fSDXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m20_Xps_pdf.root");
    //TFile *fSDXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m30_Xps_pdf.root");
    //TFile *fSDXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m40_Xps_pdf.root");
    TFile *fSDXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m45_Xps_pdf.root");
    
    //******************* Dstar_gamma_tag
    //
    //TFile *fSDstarGammaXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m00_Xps_pdf.root");
    //TFile *fSDstarGammaXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m10_Xps_pdf.root");
    //TFile *fSDstarGammaXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m20_Xps_pdf.root");
    //TFile *fSDstarGammaXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m30_Xps_pdf.root");
    //TFile *fSDstarGammaXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m40_Xps_pdf.root");
    TFile *fSDstarGammaXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m45_Xps_pdf.root");

    //******************* Dstar_pi0_tag
    //
    //TFile *fSDstarPi0Xpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m00_Xps_pdf.root");
    //TFile *fSDstarPi0Xpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m10_Xps_pdf.root");
    //TFile *fSDstarPi0Xpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m20_Xps_pdf.root");
    //TFile *fSDstarPi0Xpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m30_Xps_pdf.root");
    //TFile *fSDstarPi0Xpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m40_Xps_pdf.root");
    TFile *fSDstarPi0Xpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m45_Xps_pdf.root");

     // Background files
    //**************** Dstar_pi0_tag
    TFile *fBkgHtagDXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hBkgHtag_D_Xps_pdf.root");
    TFile *fBkgHtagDstarGammaXpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hBkgHtag_Dstar_gamma_Xps_pdf.root");
    TFile *fBkgHtagDstarPi0Xpspdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hBkgHtag_Dstar_pi0_Xps_pdf.root");
    ...
    //******************* D_tag
    //
    TFile *fSDq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m00_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m10_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m20_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m30_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m40_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m50_q2_pdf.root");
    
    //******************* Dstar_gamma_tag
    //
    TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m00_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m10_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m20_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m30_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m40_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m50_q2_pdf.root");

    //******************* Dstar_pi0_tag
    //
    TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m00_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m10_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m20_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m30_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m40_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m50_q2_pdf.root");

     // Background files
    //**************** Dstar_pi0_tag
    TFile *fBkgHtagDq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hBkgHtag_D_q2_pdf.root");
    TFile *fBkgHtagDstarGammaq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hBkgHtag_Dstar_gamma_q2_pdf.root");
    TFile *fBkgHtagDstarPi0q2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hBkgHtag_Dstar_pi0_q2_pdf.root");
 ...
 if(type==1)
    {
      ...
      hBkgD_Xpspdf = (TH1D*)fBkgHtagDXpspdf->Get("Xps");

      hSDstarGamma_Xpspdf = (TH1D*)fSDstarGammaXpspdf->Get("Xps");
      hBkgDstarGamma_Xpspdf = (TH1D*)fBkgHtagDstarGammaXpspdf->Get("Xps");
  
      hSDstarPi0_Xpspdf = (TH1D*)fSDstarPi0Xpspdf->Get("Xps");
      hBkgDstarPi0_Xpspdf = (TH1D*)fBkgHtagDstarPi0Xpspdf->Get("Xps");
   ...
   if(type==2)
    {
      ...
      hBkgD_q2pdf = (TH1D*)fBkgHtagDq2pdf->Get("q2");

      hSDstarGamma_q2pdf = (TH1D*)fSDstarGammaq2pdf->Get("q2");
      hBkgDstarGamma_q2pdf = (TH1D*)fBkgHtagDstarGammaq2pdf->Get("q2");
  
      hSDstarPi0_q2pdf = (TH1D*)fSDstarPi0q2pdf->Get("q2");
      hBkgDstarPi0_q2pdf = (TH1D*)fBkgHtagDstarPi0q2pdf->Get("q2");
  ...
  cout<<"*********************************************** "<<endl;
  cout<<"NbD: "<<NbD<<endl;
  cout<<"NbDstarGamma: "<<NbDstarGamma<<endl;
  cout<<"NbDstarPi0: "<<NbDstarPi0<<endl;
  ...
  if (type == 2){
    ...
    if (lum == 50000){
      ...
      // to m_x = 0.0    
      //w.var("mu")->setMax(4e-6);
      // to m_x = 5.0
      w.var("mu")->setMax(3e-6);
    }
  ...
  c->cd(3);
  //plot->SetRange(0,2.5e-7);
  //plot->SetRange(-0.4e-6,0.4e-6);
  //plot->SetRange(-0.6e-6,1.0e-6);
  //plot->SetRange(-10e-7,10e-7);
