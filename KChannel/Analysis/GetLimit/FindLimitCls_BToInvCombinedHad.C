...
Double_t getLimit(Double_t lum, Int_t type)
{
  ...
  RooHistPdf *b_pdf;
    ...
    //TFile *fSDq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_D_m45_q2_pdf.root");
    ...
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_gamma_m45_q2_pdf.root");
    ...
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/KChannel/Analysis/Files/RootFiles/hS_Had_Dstar_pi0_m45_q2_pdf.root");
