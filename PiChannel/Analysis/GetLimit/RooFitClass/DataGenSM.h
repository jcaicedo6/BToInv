...
// Wed Sep  4 12:25:29 2019 by ROOT version 6.14/06
// from TTree tree/
// found on file: myoutputCMS_SM.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        tau_nu_e_px_CMS[kMax__ncandidates_];   //[__ncandidates__]
   Double_t        tau_nu_e_py_CMS[kMax__ncandidates_];   //[__ncandidates__]
   Double_t        tau_nu_e_pz_CMS[kMax__ncandidates_];   //[__ncandidates__]
   Double_t        tau_nu_e_p_CMS[kMax__ncandidates_];   //[__ncandidates__]
   Double_t        tau_nu_e_E_CMS[kMax__ncandidates_];   //[__ncandidates__]
   Double_t        tau_nu_e_M[kMax__ncandidates_];   //[__ncandidates__]
   ...
   TBranch        *b_tau_e_M;   //!
   TBranch        *b_tau_nu_e_px_CMS;   //!
   TBranch        *b_tau_nu_e_py_CMS;   //!
   TBranch        *b_tau_nu_e_pz_CMS;   //!
   TBranch        *b_tau_nu_e_p_CMS;   //!
   TBranch        *b_tau_nu_e_E_CMS;   //!
   TBranch        *b_tau_nu_e_M;   //!
...
#ifdef DataGenSM_cxx
DataGenSM::DataGenSM(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("myoutputCMS_SM.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("myoutputCMS_SM.root");
      }
...
Int_t DataGenSM::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DataGenSM::LoadTree(Long64_t entry)
{
...
void DataGenSM::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("tau_nu_e_px_CMS", tau_nu_e_px_CMS, &b_tau_nu_e_px_CMS);
   fChain->SetBranchAddress("tau_nu_e_py_CMS", tau_nu_e_py_CMS, &b_tau_nu_e_py_CMS);
   fChain->SetBranchAddress("tau_nu_e_pz_CMS", tau_nu_e_pz_CMS, &b_tau_nu_e_pz_CMS);
   fChain->SetBranchAddress("tau_nu_e_p_CMS", tau_nu_e_p_CMS, &b_tau_nu_e_p_CMS);
   fChain->SetBranchAddress("tau_nu_e_E_CMS", tau_nu_e_E_CMS, &b_tau_nu_e_E_CMS);
   fChain->SetBranchAddress("tau_nu_e_M", tau_nu_e_M, &b_tau_nu_e_M);
...
void DataGenSM::Show(Long64_t entry)
{
...
Int_t DataGenSM::Cut(Long64_t entry)
{
