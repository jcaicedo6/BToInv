...
void FindLimitCls_BToInvCombined()
{
  ...
  //limit[4] = getLimit2D(lum,pdf_type);
...
Double_t getLimit(Double_t lum, Int_t type)
{
  ...
  RooHistPdf *b_pdf;
    ...
    //******************* D_tag
    //
    //TFile *fSDq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_D_m00_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_D_m10_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_D_m20_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_D_m30_q2_pdf.root");
    //TFile *fSDq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_D_m40_q2_pdf.root");
    TFile *fSDq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_D_m50_q2_pdf.root");
    
    //******************* Dstar_gamma_tag
    //
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_gamma_m00_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_gamma_m10_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_gamma_m20_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_gamma_m30_q2_pdf.root");
    //TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_gamma_m40_q2_pdf.root");
    TFile *fSDstarGammaq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_gamma_m50_q2_pdf.root");

    //******************* Dstar_pi0_tag
    //
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_pi0_m00_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_pi0_m10_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_pi0_m20_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_pi0_m30_q2_pdf.root");
    //TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_pi0_m40_q2_pdf.root");
    TFile *fSDstarPi0q2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hS_Dstar_pi0_m50_q2_pdf.root");

     // Background files
    //**************** Dstar_pi0_tag
    TFile *fBkgStagDq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hBkgStag_D_q2_pdf.root");
    TFile *fBkgStagDstarGammaq2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hBkgStag_Dstar_gamma_q2_pdf.root");
    TFile *fBkgStagDstarPi0q2pdf = new TFile("~/BToInv/PiChannel/Analysis/Files/RootFiles/hBkgStag_Dstar_pi0_q2_pdf.root");
 ...
 if(type==3)
  ...
  if (type == 1){
    ...
    if (lum == 50000){
      ...
      w.factory("B[8284.0,8000.0,8500.0]");
      ...
      // to m_X = 0.0
      //w.var("mu")->setMin(-2e-6);
      // to m_X = 2.0
      //w.var("mu")->setMin(-1.0e-6);
      // to m_x = 5.0
      w.var("mu")->setMin(-0.5e-6);
  
  
      // to m_X = 0.0   
      //w.var("mu")->setMax(2.3e-6);  
      // to m_X = 2.0  
      //w.var("mu")->setMax(1.0e-6);
      // to m_x = 5.0
  ...
  if (type == 3){
    ...
    if (lum == 362){
      ...
      // to m_X = 0.0   
      //w.var("mu")->setMax(2.0e-5);  
      // to m_X = 3.0  
      w.var("mu")->setMax(1.5e-5);
    ...
    if (lum == 50000){
      ...
      w.factory("mu[4e-8, -1.0,1.0]");
      //w.factory("S[0.0,0.0,10.0]");
      w.factory("B[6125.0,5000.0,8000.0]");
      ...
      w.var("mu")->setMin(0);
      //w.var("mu")->setMin(-1.5e-6);
      //w.var("mu")->setMin(-1.0e-6);
      //w.var("mu")->setMin(-5.0e-7);
      

  
  
      // to m_x = 0.0    
      //w.var("mu")->setMax(1.6e-6);
      // to m_x = 2.0
